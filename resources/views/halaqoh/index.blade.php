...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Halaqoh</h4>
        <x-alert />
        <div class="card mb-4">
            <h5 class="card-header">Tambah Halaqoh Baru</h5>
            <div class="card-body">
                <div>
                    <form enctype="multipart/form-data" action="{{ url('halaqoh/simpan') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Nama Halaqoh</label>
                            <input type="text" class="form-control" id="basic-default-fullname"
                                placeholder="Masukkan nama" name="nama">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">Pengampu</label>
                            <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example"
                                required name="guru_id">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($halaqoh as $i)
                            <tr>
                                ...
                                <td>{{ $i->guru->nama }}</td>
                                <td><a href="{{ route('isi-halaqoh', ['id' => $i->id]) }}"><span
                                            class="badge bg-label-primary me-1">Daftar Santri</span></a></td>
                                <td>
                                <td>
                                    <div class="dropdown">
