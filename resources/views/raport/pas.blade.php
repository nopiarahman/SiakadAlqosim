    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card d-flex justify-content-center table-responsive">
            ...
            width:599pt'>
                        ...
                        @if ($dataRaport && $dataRaport->status != null && getPeriodeAktif()->semester === 'genap')
                        <tr height=136 style='mso-height-source:userset;height:102.0pt'>
                            <td colspan=7 height=136 class=xl118 width=420 style='height:102.0pt; width:315pt'>
                                <font class="font6">Keputusan:<br></font>
                                <font class="font7">Berdasarkan pencapaian kompetensi pada semester ke-1 dan ke-2, peserta didik ditetapkan *)<br></font>
                                @if($dataRaport->status == "naik")
                                    <font class="font7">naik ke kelas<span style='mso-spacerun:yes'></span>{{$dataRaport->tujuan}}<br></font>
                                @elseif($dataRaport->status == "tinggal")
                                    <font class="font7">tinggal di kelas<span style='mso-spacerun:yes'></span>{{$dataRaport->tujuan}}<br></font>
                                @endif
                            </td>
                            <td colspan=2 style='mso-ignore:colspan'></td>
                        </tr>
